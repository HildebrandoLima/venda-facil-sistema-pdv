...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script type="text/javascript" src={{ asset('js/exibirCard.js') }}></script>
    ...
    <div class="container mt-3">
        <h5 class="card-title text-center">Método de Pagamento</h5>
            <div class="row">
                <select onchange='mostraCard(this)' class="form-select">
                    <option selected>Escolha o Método de Pagamento</option>
                    <option value="Dinheiro">Dinheiro</option>
                    <option value="Cartão">Cartão</option>
                </select>

                <div id="metodoDinheiro" style="display:none">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Método Escolhido - Dinheiro</h5>
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="troco" class="form-control" required />
                                                <span class="input-group-text"><i class="icon fa fa-money"></i></span>
                                            </div>
                                        </div>
                ...
                <div id="metodoCartao" style="display:none">
                    <aside class="col-lg-15 mt-3">
                        <form action="{{ route('pagamento') }}" method="post">
                        @csrf
                        <input type="hidden" name="venda_id" value="{{ $vendaId }}" />
